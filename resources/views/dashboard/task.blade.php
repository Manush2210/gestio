...
<a class="dropdown-item d-flex align-items-center" href="#">Se déconnecter <i class="fa fa-toggle-off fa-fw ms-auto text-dark text-opacity-50"></i></a>
</div>
</div>
</div>
...
<span class="menu-text">Terminées</span>
</a>
</div>
