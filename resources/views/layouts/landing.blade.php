...
<head>
    ...
    <!-- Favicon -->
<link rel="shortcut icon" href="{{ asset('gestio/landing/favicon.ico') }}">

<!-- Font -->
<link href="https://fonts.googleapis.com/css2e9cf.css?family=Roboto:wght@400;500;700&amp;display=swap" rel="stylesheet">

<!-- CSS Implementing Plugins -->
<link rel="stylesheet" href="{{ asset('gestio/landing/css/vendor.min.css') }}">

<!-- CSS Space Template -->
<link rel="stylesheet" href="{{ asset('gestio/landing/css/theme.minc619.css?v=1.0') }}">
...
<main id="content" role="main">
        ...
        <div class="container content-space-2">
          <div class="row justify-content-center align-items-lg-center">
            <div class="col-md-8 col-lg-6 mb-7 mb-lg-0">
              ...
              <div class="pe-lg-3 mb-7">
                <h1 class="display-3 text-white mb-3 mb-md-5">GESTIO est conçu pour les
                  <span class="text-warning">
                    <span class="js-typedjs"
                          data-hs-typed-options='{
                            "strings": ["écoles.", "hôpitaux.","restaurants.","agences.", "boutiques.","entreprises de tout genre."],
                            "typeSpeed": 90,
                            "loop": true,
                            "backSpeed": 30,
                            "backDelay": 2500
                ...
                <hr>
                <p class="lead text-white-70">Utilisez cette plateforme web pour controler la gestion et l'évolution de votre activité, de votre personnel et de vos finances tout en profitant de nos astuces pour accroître votre chiffre d'affaire.</p>
              </div>
              <!-- End Heading -->
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-4">
                      <h6 class="text-white mb-0">24/7</h6>
                      <p class="text-white-70">Assistance en ligne</p>
                    </div>
                  </div>
                  <!-- End Info Block -->
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-4">
                      ...
                      <p class="text-white-70">Utilisateurs</p>
                    </div>
                  </div>
                  <!-- End Info Block -->
                </div>
                ...
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="row align-items-sm-center mb-5">
                      ...
                      <div class="col-sm">
                        <h5 class="card-title">Essayez GESTIO</h5>
                        <p class="card-text">Faites nous confiance pour améliorer la qualité et la rentabilité de votre business</p>
                      </div>
                      <!-- End Col -->
                    </div>
                    <!-- End Row -->
          ...
          <div class="row">
            <div class="col-sm mb-5 mb-sm-0">
              ...
              <blockquote class="blockquote blockquote-sm text-white mb-4">“ C'est une très belle interface avec des fonctionnalités épatantes ”</blockquote>
            ...
            <div class="col-sm mb-5 mb-sm-0">
              ...
              <blockquote class="blockquote blockquote-sm text-white mb-4">“ GESTIO nous a permis d'augmenter la qualité de notre organisation et de nos services en un temps record ”</blockquote>
            ...
            <div class="col-sm mb-5">
              ...
              <blockquote class="blockquote blockquote-sm text-white mb-4">“ Il est temps pour toutes les entreprises de se digitaliser et je leur conseille fortement d'utiliser le service GESTIO. ”</blockquote>
      ...
      <div class="container content-space-t-1 content-space-t-md-3">
        ...
        <div class="w-lg-65 text-center mx-lg-auto mb-7">
          <h3>Tout ce qu'il y a à savoir sur GESTIO</h3>
...
<div class="modal-footer d-block text-center py-sm-5">
            ...
            <div class="w-85 mx-auto">
              <div class="row justify-content-between">
                <div class="col">
                  <img class="img-fluid" src="{{ asset('gestio/landing/svg/brands/gitlab-gray.svg') }}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{ asset('gestio/landing/svg/brands/fitbit-gray.svg') }}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{ asset('gestio/landing/svg/brands/flow-xo-gray.svg') }}" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col">
                  <img class="img-fluid" src="{{ asset('gestio/landing/svg/brands/layar-gray.svg') }}" alt="Logo">
                </div>
                <!-- End Col -->
              </div>
            </div>
